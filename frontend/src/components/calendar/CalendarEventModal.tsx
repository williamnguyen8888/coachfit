      ...
      >
        ...
        <button
          ...
          style={{
            ...
            gap: "var(--space-2)",
            padding: "var(--space-2) var(--space-3)",
            background: selectedId === null ? "rgba(139,92,246,0.15)" : "transparent",
          ...
          filtered.map((w) => (
            <button
              ...
              style={{
                ...
                gap: "var(--space-2)",
                padding: "var(--space-2) var(--space-3)",
                background: selectedId === w.id ? "rgba(139,92,246,0.15)" : "transparent",
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            background: submitting || !canSubmit ? "rgba(139,92,246,0.4)" : "var(--color-accent)",
            border: "none",
            borderRadius: "var(--radius-sm)",
            color: "white",
            fontSize: "var(--text-sm)",
